  ...
  return (
    ...
    >
      <motion.div
        ...
        className="menu remove-scrollbar flex-column absolute right-0 top-0 isolate h-dvh w-[80%] max-w-[500px] overflow-hidden bg-background-100 px-[4%] pb-6 pt-4 backdrop-blur-sm"
